...
<body class="bg-gray-100 p-4 flex flex-col items-center">
    ...
    <form action="quiz.php" method="post" class="w-full max-w-md">
        ...
        foreach ($quiz->getQuestions() as $questionID => $question) {
            echo "<div class='mb-4 p-4 bg-white rounded-lg shadow-md'>";
        ...
        <button type="submit" name='submit'
            class='w-full bg-blue-500 text-white font-serif py-2 px-4 rounded hover:bg-blue-600 mt-4'>Soumettre</button>
    </form>
    ...
    <div class="fixed bottom-4 right-4 p-2 bg-blue-500 rounded-lg shadow-md">
        <a href="../lessonOnLine/lessonOnLine.php"
            class="text-white hover:bg-blue-600 hover:text-white py-1 px-3 rounded-md transition-all duration-300">Retour</a>
    </div>
