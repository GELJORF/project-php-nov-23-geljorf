...
<body class="bg-gray-100 p-8">
    ...
    <div <?php if ($contentShouldHaveWhiteBackground) {
        ...
        <div class="max-w-3xl mx-auto mt-8 mb-8">
            <h1 class="text-4xl font-bold text-blue-900 mb-6"><?php echo $dynamicTitle; ?></h1>
            <p class="text-lg font-bold text-black-900 leading-7 mb-6"><?php echo $dynamicText; ?></p>
